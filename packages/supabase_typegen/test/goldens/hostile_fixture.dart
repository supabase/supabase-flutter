  ...
  tables: [
    TableDescription(
      ...
      columns: [
        ...
        ColumnDescription(
          name: 'spans',
          postgresFormat: '_int4range',
          typeKind: ColumnTypeKind.array,
          elementTypeKind: ColumnTypeKind.range,
        ...
        ColumnDescription(
          name: 'stamps',
          postgresFormat: '_timestamptz',
          typeKind: ColumnTypeKind.array,
          elementTypeKind: ColumnTypeKind.timestampWithTimeZone,
          isRequired: false,
          hasDefault: false,
          isNullable: true,
        ),
