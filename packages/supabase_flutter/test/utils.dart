...
(String accessToken, String currentSession, String sessionString)
    getSessionData(DateTime dateTime) {
  ...
  final sessionString =
      jsonEncode(jsonDecode(currentSession)..['expires_at'] = expiresAt);
