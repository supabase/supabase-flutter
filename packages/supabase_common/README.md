...
packages: the `SupabaseException` base class every service exception extends,
the `X-Client-Info` header builder, platform detection, a small replay stream
subject, base64url/PKCE helpers and a few other primitives.
