...
({String accessToken, String sessionString}) getSessionData(DateTime dateTime) {
  ...
  final sessionString =
      ...
      '${dateTime.difference(DateTime.now()).inSeconds},"refresh_token":"-yeS4o'
      'mysFs9tpUYBws9Rg","token_type":"bearer","provider_token":null,"provider_'
      'refresh_token":null,"user":{"id":"4d2583da-8de4-49d3-9cd1-37a9a74f55bd",'
      '"app_metadata":{"provider":"email","providers":["email"]},"user_metadata'
      '":{"Hello":"World"},"aud":"","email":"fake1680338105@email.com","phone":'
      '"","created_at":"2023-04-01T08:35:05.208586Z","confirmed_at":null,"email'
      '_confirmed_at":"2023-04-01T08:35:05.220096086Z","phone_confirmed_at":nul'
