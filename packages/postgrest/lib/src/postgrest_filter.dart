...
/// - A [PostgrestRange] is its literal, `[2,25)`.
/// - A [PostgrestDate], [PostgrestTime] or [PostgrestInterval] is its
///   literal, `2024-02-29`, `09:30:00+02` or `1 mon 3 days`.
...
String _renderFilterValue(Object? value) => switch (value) {
  ...
  PostgrestDate() => value.literal,
  PostgrestTime() => value.literal,
  PostgrestInterval() => value.literal,
  _ => value.toString(),
};
